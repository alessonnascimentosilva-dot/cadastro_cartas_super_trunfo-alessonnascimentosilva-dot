# cadastro_cartas_super_trunfo-alessonnascimentosilva-dot
Desafio em linguagem C para a criação do jogo "Super Trunfo" - ESTACIO SE SÁ (Curso de Ciência de dados)
